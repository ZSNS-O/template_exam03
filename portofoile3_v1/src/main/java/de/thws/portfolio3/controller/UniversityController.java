...
public class UniversityController {
    ...
    public ResponseEntity<PagedModel<EntityModel<University>>> getAll(Pageable pageable) {
        ...
        headers.add("Link", linkTo(methodOn(UniversityController.class).getAll(Pageable.unpaged().first())).withRel("first").toUri().toString());
        headers.add("Link", linkTo(methodOn(UniversityController.class).getAll(Pageable.unpaged())).withRel("last").toUri().toString());
    ...
    @GetMapping("/search")
    public ResponseEntity<List<EntityModel<University>>> search(
